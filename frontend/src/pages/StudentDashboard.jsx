			...
			>
				<Container maxWidth="lg">
					...
					>
						...
						{activeTab === "add" && (
							<AddAcademicForm student={student} />
						)}
						{activeTab === "predictor" && (
							<PlacementPredictor student={student} />
						)}
						{activeTab === "group" && (
							<Box>
								<Box
								...
								>
									...
									<Box>
										...
										>
											View your assigned group information
											and details
										</Typography>
									</Box>
								</Box>
								...
								{groupLoading ? (
									...
									>
										...
										<Grid container spacing={3}>
											{[
												{
													label: "Group ID",
													value: studentGroup.Group_ID,
													icon: <FingerprintIcon />,
												},
												{
													label: "Group Name",
													value: studentGroup.Group_Name,
													icon: <GroupIcon />,
												},
												{
													label: "Current Year",
													value: `Year ${studentGroup.Current_Year}`,
													icon: <CalendarIcon />,
												},
												{
													label: "Assigned By",
													value: studentGroup.Admin_Name,
													icon: <AdminIcon />,
												},
											].map((item, index) => (
												<Grid
									...
									>
										...
										>
											...
											group yet. Please contact your
											teacher to get assigned to a group.
										</Typography>
									</Paper>
								)}
							</Box>
