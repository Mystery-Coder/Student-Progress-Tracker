...
export default function PlacementPredictor({ student }) {
	...
	const handlePredict = async () => {
		...
		try {
			const response = await fetch(
				`http://localhost:5000/predict/${usn.trim().toUpperCase()}`,
			);
	...
	return (
		<Box>
			...
			>
				AI-powered prediction of your placement chances based on
